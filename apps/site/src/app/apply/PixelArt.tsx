...
export default function PixelArt() {
    ...
    const openDialog = (ref: React.RefObject<HTMLDialogElement>) => ref.current?.showModal();
    const closeDialog = (ref: React.RefObject<HTMLDialogElement>) => ref.current?.close();
    ...
    return (
        ...
        >
            ...
            <div className={styles.palette} aria-label="Color palette" onClick={(e) => e.stopPropagation()}>
            ...
            <dialog ref={clearModalRef} className={styles.modal}>
                <div className={styles.modalBox}>
                    ...
                    <p className={styles.modalBody}>Are you sure you want to clear the entire canvas? This cannot be undone.</p>
                    <div className={styles.modalActions}>
                        <button type="button" className={styles.secondaryBtn} onClick={() => closeDialog(clearModalRef)}>Cancel</button>
                        <button type="button" className={styles.dangerBtn} onClick={clearCanvas}>Clear</button>
                    </div>
                </div>
            </dialog>
